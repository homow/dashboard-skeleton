...
function Section3DImages({data, className}) {
    ...
    return (
        <div className={cn("relative w-full main-components", className)}>
            ...
            <span className={cn("px-1.5 py-0.5 text-xs rounded-full", color, bg)}>{text}</span>
        </div>
    )
}
...
function TransActions({className}) {
    return (
        <div className={cn("@container main-components", className)}>
...
export default function Page2() {
    ...
    return (
        <section
            id="top-section"
            className={"mt-8 grid grid-cols-1 gap-2 @lg/main:grid-cols-2 @3xl/main:grid-cols-11"}>
